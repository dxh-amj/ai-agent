        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-slate-600 mb-8 leading-relaxed">
              When one agent completes a task, it automatically triggers the
              next. Your AI workforce communicates and collaborates—just like a
              real team.
            </p>
          ...
          <div className="relative flex items-center justify-center">
            <div className="relative w-full max-w-sm aspect-square">
              ...
              {/* Center hub */}
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center shadow-lg shadow-emerald-500/25 z-10">
