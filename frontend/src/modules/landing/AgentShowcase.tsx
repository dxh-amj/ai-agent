      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="text-slate-600">
            Each agent masters a critical business function. Together, they form
            an intelligent workforce that operates around the clock.
          </p>
        </div>
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  >
                    <span
                      className={`material-symbols-outlined text-xl bg-gradient-to-r ${agent.color} bg-clip-text text-transparent`}
                    >
                      {agent.icon}
                    </span>
                  </div>
