            ...
            <div className="flex flex-col md:flex-row justify-between gap-8 mb-12">
              ...
              <div className="max-w-sm">
                ...
                <div className="flex items-center gap-3 mt-6">
                  <Link
                    href="#"
                    className="w-9 h-9 rounded-lg bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-500 hover:text-primary hover:border-primary/30 transition-all"
                  >
